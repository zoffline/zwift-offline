...
* Install Zwift
  ...
  * If your Zwift version is newer than 1.0.100118 and zoffline is running from source: copy ``C:\Program Files (x86)\Zwift\Zwift_ver_cur.xml`` to zoffline's ``cdn/gameassets/Zwift_Updates_Root/`` overwriting the existing file.
  * If your Zwift version is newer than 1.0.100118 and zoffline is not running from source: wait for zoffline to be updated.
