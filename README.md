...
* Install Zwift
  * If your Zwift version is newer than 1.0.38296 you may have to uninstall, then reinstall after installing zoffline.
  * If your Zwift version is 1.0.38296, you're all set.
  * If Zwift is not installed install it after installing zoffline (1.0.38296 will be installed instead of the latest).
